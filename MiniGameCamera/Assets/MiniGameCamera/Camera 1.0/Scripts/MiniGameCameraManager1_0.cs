...
public class MiniGameCameraManager1_0 : MonoBehaviour
{
    ...
    [Header("Photo")]
    [SerializeField]
    private MiniGameCameraDataManager1_0 MiniGameCameraDataManager;
    [SerializeField]
    ...
    public void UpMoveButton() => MoveVector = "null";
}
